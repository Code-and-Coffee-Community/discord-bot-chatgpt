 ...
 */
declare function getOpenAIAuth({ email, password, timeoutMs, browser }: {
    email?: string;
    password?: string;
    timeoutMs?: number;
    browser?: Browser;
